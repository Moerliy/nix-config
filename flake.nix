...

{
  ...
  outputs = inputs @ { self, nixpkgs, nixpkgs-unstable, nixos-hardware, home-manager, home-manager-unstable, darwin, nur, nixgl, hyprland, hyprlock, hypridle, hyprspace, plasma-manager, ... }: # Function telling flake which inputs to use
    let
